package com.vipgti.nvempleados.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "nvempleados@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "nvempleados API";

        private String description = "nvempleados API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "nvempleados";
